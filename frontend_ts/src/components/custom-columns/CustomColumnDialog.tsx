            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g., Fit Score" {...field} />
                  </FormControl>
                  <FormDescription>
                    The name displayed in the table header.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="e.g., How well this account fits our target profile"
                      {...field}
                      value={field.value || ""}
                    />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="e.g., Based on this company's profile, how well does it fit our ICP for [Product Name]?"
                      rows={4}
                      {...field}
                    />
                  </FormControl>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center space-x-3 space-y-0">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      Enable internet access to the AI model.
                    </FormDescription>
                  </div>
                  <FormMessage />
                </FormItem>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center space-x-3 space-y-0 rounded-md border p-3 shadow-sm bg-gray-50">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      Enable this column for generation.
                    </FormDescription>
                  </div>
                  <FormMessage />
                </FormItem>
