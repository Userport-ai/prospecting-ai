...
import { leadsColumns, LeadTableRow } from "./Columns";
  ...
  return [
    {
      ...
      name: "John Smith",
      company_name: "Google",
      linkedin_url: "https://www.linkedin.com/johsmith",
    ...
    },
    {
      ...
      name: "Jane Brown",
      company_name: "Stripe",
      linkedin_url: "https://www.linkedin.com/janebrown",
...
export default function Leads() {
  const [data, setData] = useState<LeadTableRow[]>(getData());
  const [columns, setColumns] = useState<ColumnDef<LeadTableRow>[]>(leadsColumns);
