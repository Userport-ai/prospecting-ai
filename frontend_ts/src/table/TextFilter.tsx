  ...
  return (
    <div>
      <Input
        ...
        value={
          (table.getColumn(columnId)?.getFilterValue() as InputValue) ?? ""
        }
        onChange={onChange}
        className="max-w-sm text-gray-600 shadow-sm bg-white border-gray-200 focus:ring-primary focus:border-primary"
      />
    </div>
  );
};
