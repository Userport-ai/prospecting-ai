...
const VisibleColumns: React.FC<{ table: Table<any> }> = ({ table }) => {
  return (
    <div>
      <Popover>
        <PopoverTrigger className="flex gap-2 items-center px-4 py-2 text-sm font-medium text-gray-600 rounded-md shadow-sm bg-white hover:bg-gray-100 transition duration-300 border border-gray-200">
          <Eye size={18} />
