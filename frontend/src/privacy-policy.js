// Component that displays privacy policy on the App.
function PrivacyPolicy() {
  // Privacy Policy link:https://www.termsfeed.com/live/8aa65c78-8f14-4c68-ae4f-6453da49f8a3.
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Userport, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Userport, Inc., 1515 Poppy Way, Cupertino,
            CA 95014.
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: addarsh@userport.ai</li>
      </ul>
    </div>
  );
}
