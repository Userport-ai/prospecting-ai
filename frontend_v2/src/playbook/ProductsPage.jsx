    ...
    <Card className=" bg-white shadow-lg rounded-xl border border-gray-200 overflow-hidden transition-transform hover:shadow-2xl">
      ...
      <CardContent className="p-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-700 text-base">{product.icp}</p>
        </div>
      ...
      <CardFooter className="p-4 bg-gray-50 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
        ...
        <div className="text-sm text-gray-500 space-y-1">
          <p>
            ...
            <span className="text-gray-800">{product.creationDate}</span>
          </p>
          <p>
            <span className="font-semibold">Last Updated:</span>{" "}
            <span className="text-gray-800">{product.lastUpdated}</span>
          </p>
        </div>
        ...
        <div className="text-sm text-gray-500">
          <p>
            ...
            <span className="text-gray-800">{product.createdBy}</span>
          </p>
          <p>
            <span className="font-semibold">Last Updated By:</span>{" "}
            <span className="text-gray-800">{product.lastUpdatedBy}</span>
          </p>
        </div>
      </CardFooter>
    </Card>
  ...
  const products = [
    {
      ...
      icp: "Sales teams at Series B+ companies",
      personas: ["VP of Sales", "Director of Sales", "Account Executive"],
