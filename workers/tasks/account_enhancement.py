    ...
    async def _fetch_company_profile(self, company_name: str) -> Optional[str]:
        try:
            ...
            headers = {
                ...
                "User-Agent": "AccountEnrichmentService/1.0"
            }
...
3. If field information is not available, use null.
...
"""
            ...
            raw_text = structure_response.parts[0].text.strip()
    ...
    async def execute(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        try:
            ...
            analysis_prompt = (
                f"Analyze this company profile and provide a concise business summary."
                f"Focus on key metrics, market position, and recent developments."
                f"Company Profile:\n{company_profile}"
            )
            ...
            await self._store_error_state(job_id, account_id, {"error_type": "unexpected_error", "message": str(e)})
