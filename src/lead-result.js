    ...
    <div id="lead-result-outer">
      <div id="lead-result-container">
        ...
        <Flex id="info-container" vertical={true} gap="large">
          <InfoSection cardInfo={aboutPerson}></InfoSection>
          <InfoSection cardInfo={thoughts}></InfoSection>
          <InfoSection cardInfo={events}></InfoSection>
          <InfoSection cardInfo={financials}></InfoSection>
          <InfoSection cardInfo={awards}></InfoSection>
          <InfoSection cardInfo={announcements}></InfoSection>
          <InfoSection cardInfo={productUpdates}></InfoSection>
        </Flex>
